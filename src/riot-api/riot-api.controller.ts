...
export class RiotApiController {
  ...
  @Get('match-history')
  @ApiOperation({
    summary: "Get match history for the logged-in user's linked Riot account",
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Initiate Riot account linking (captures current icon)',
  })
  @ApiResponse({
    status: 200,
    description: 'Link initiated — change your icon then verify',
  })
