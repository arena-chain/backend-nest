import { IsString, IsNotEmpty, IsNumber, Min, IsArray, IsEnum, IsOptional } from 'class-validator';
...
export class CreateAbonnementDto {
    @ApiProperty({ enum: AbonnementType, description: 'Type of the subscription plan' })
