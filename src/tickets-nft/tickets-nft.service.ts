...
export class TicketsNftService {
    ...
    private readonly wallet = new ethers.Wallet(process.env.PRIVATE_KEY || '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80', this.provider);
    private readonly contract = new ethers.Contract(
        process.env.TICKET_NFT_CONTRACT_ADDRESS || '0x0000000000000000000000000000000000000000',
        [
