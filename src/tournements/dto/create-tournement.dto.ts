...
export class CreateTournementDto {
  @ApiProperty({
    ...
    example: 'Winter Championship 2026',
  })
  @IsString()
  @IsNotEmpty()
  name: string;
  ...
  @ApiPropertyOptional({
    ...
    enum: TournamentType,
    example: TournamentType.OFFICIAL,
  })
  ...
  @ApiPropertyOptional({
    ...
    example: { bestOf: 3, mapPool: ['Dust2', 'Inferno'] },
  })
  @Transform(({ value }) => {
  ...
  @ApiPropertyOptional({
    description: 'Registration open status',
    default: true,
  })
  ...
  @ApiPropertyOptional({
    description: 'Custom ticket types for this tournament',
    type: [TicketTypeDto],
  })
  @IsArray()
  @ValidateNested({ each: true })
