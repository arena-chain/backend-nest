...
export class ChannelController {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Check if user is subscribed to a channel' })
  isSubscribed(@Req() req, @Param('id') id: string) {
    return this.channelService.isSubscribed(id, req.user.userId);
  }
}
