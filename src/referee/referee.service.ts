...
import { RefereeProfile, RefereeProfileDocument } from './schemas/referee-profile.schema';

@Injectable()
export class RefereeService {
    constructor(
        @InjectModel(RefereeProfile.name) private refereeProfileModel: Model<RefereeProfileDocument>,
    ) { }
    ...
    async findByUserId(userId: string | Types.ObjectId): Promise<RefereeProfileDocument> {
