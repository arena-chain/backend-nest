...
export class CatalogController {
  ...
  @ApiOperation({
    ...
    description: 'Add a new game to the catalog with optional cover image',
  })
    ...
    schema: {
      ...
      properties: {
        ...
        file: {
          type: 'string',
          format: 'binary',
          description: 'Cover image file (JPG, JPEG, PNG, GIF)',
        },
  ...
  @ApiOperation({
    ...
    description: 'Retrieve all games in the catalog',
  })
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific game from the catalog',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update an existing game in the catalog with optional new cover image',
  })
  @ApiParam({ name: 'id', description: 'Catalog item ID' })
  @ApiConsumes('multipart/form-data')
  @ApiBody({
